...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration setDividerWidth(int width){
    ...
    public DividerItemDecoration setDrawableColor(int color){
        mDivider.setTint(ActivityCompat.getColor(context, color));
        return this;
    }
